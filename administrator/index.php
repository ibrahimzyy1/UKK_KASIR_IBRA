            ...
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php
                        include('../koneksi.php');
                        $datapetugas = mysqli_query($koneksi, "SELECT * FROM petugas");
                        $jumlahpetugas = mysqli_num_rows($datapetugas);
                        ?>
...
<div class="card mt-5">
    <div class="card-body">
        <p>Selamat Datang dihalaman Administrator, Silahkan anda bisa mengakses beberapa
            fitur</p>
    </div>
</div>
